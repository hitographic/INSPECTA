...
export const ENV_CONFIG = {
  ...
  SUPABASE_ANON_KEY: import.meta.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNtZ3lrdWtwY2x4YmdicWd5c2x2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQ4MTIzODEsImV4cCI6MjA4MDM4ODM4MX0.Fpea0d3KMUpVw0GxYOg7cMTACS1tAUlvzCUGO-93AfE'
};
